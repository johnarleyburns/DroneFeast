...
### Important changes
* Speaker event "OnSpeakNativeStart" removed: use "OnSpeakStart" instead
* Speaker event "OnSpeakNativeComplete" removed: use "OnSpeakComplete" instead
* Class "SpeakNativeEventArgs" removed: use "SpeakEventArgs" instead
